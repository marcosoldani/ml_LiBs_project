...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{task2_cross_pair_heatmap.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{task2_per_temp_accuracy.pdf}
...
nella UI sia in \cref{fig:task2-fi}.
\\Le tre feature più informative
sono nell'ordine:
