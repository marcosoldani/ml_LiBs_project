...
\subsection{Kolmogorov--Smirnov (\texorpdfstring{\acrshort{ks}}{KS})}
...
\subsection{Population Stability Index (\texorpdfstring{\acrshort{psi}}{PSI})}
...
multimodali quando una moda compensa l'altra. Combinandoli (si considera drift se almeno uno dei due metodi lo segnala) si riducono i falsi negativi.
...
\section{Esposizione \texorpdfstring{\acrshort{rest}}{REST}}
