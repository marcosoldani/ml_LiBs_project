...
In tutti e tre i task, la differenza tra l’uso di una cross-validation leakage-free (\acrshort{logo} o \texttt{StratifiedGroupKFold}) e una cross-validation row-wise è determinante. I risultati riportati in \cref{tab:task1-benchmark,tab:task2-benchmark,tab:task3-benchmark} risultano infatti \emph{realistici} proprio grazie alla scelta di splitter coerenti con il task.
...
Aggiungere feature più complesse avrebbe portato un guadagno marginale a fronte di un costo
