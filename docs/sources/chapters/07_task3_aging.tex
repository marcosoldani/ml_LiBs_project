...
sempre sotto $\SI{0.072}{\milli\ohm}$ in modulo.
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{task3_metrics_bar.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.80\linewidth]{task3_per_temp.pdf}
...
\begin{figure}[htbp]
  ...
  Il 95\textsuperscript{o} percentile cade sotto i \SI{0.2}{\milli\ohm},
