...
Politecnico di Milano e descritta in~\cite{polimi2025battery}. La
...
\subsection{Mappatura dataset $\to$ paper}

Le variabili della~\cref{tab:dataset-schema} provengono dal protocollo
...
$\mathcal{O}(\SI{1}{\milli\ohm})$, che fissa un \emph{floor} di errore
