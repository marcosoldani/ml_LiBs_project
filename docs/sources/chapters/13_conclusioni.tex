...
dispersione fisiologica delle misure ($\sim$\SI{1}{\milliohm}). Per il
...
Le limitazioni discusse in \cref{chap:conclusions} sono state esplicitate e quantificate, delineando una roadmap chiara e concreta per gli sviluppi futuri.
\\\\
Si desidera infine ringraziare il docente per la disponibilità e il supporto forniti durante lo sviluppo del progetto.