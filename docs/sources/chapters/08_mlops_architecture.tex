\chapter{Architettura \acrshort{mlops}}
\label{chap:mlops}
...
Questo capitolo è il cuore \emph{ingegneristico} del report: descrive
...
parametri, le metriche e la durata. Per ciascun parent run logghiamo:
\begin{itemize}
