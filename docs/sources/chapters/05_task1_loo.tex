...
\begin{table}[H]
  \centering
  \caption{Baseline per Task 1 e Task 3 (gli stessi modelli di
  \codefile{src/models/registry.py::regression\_models}).}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.78\linewidth]{task1_actual_vs_pred.pdf}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.80\linewidth]{task1_residuals_per_soc.pdf}
  ...
  ($\sim$\SI{1}{\milli\ohm}); i SOC estremi (0 e 4) hanno una coda
